      ...
      <main className="flex-1 flex items-center justify-center p-6 text-center">
        <div className="max-w-md w-full space-y-8 animate-in fade-in zoom-in duration-500">
          <div className="relative inline-block">
            <div className="text-[8rem] sm:text-[12rem] font-headline font-bold text-primary/10 leading-none select-none">404</div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              We couldn't find the page you're looking for. It may have been moved or vanished into thin air.
            </p>
          </div>
          ...
          <div className="pt-8">
            <button 
              ...
              className="text-sm font-bold text-primary flex items-center gap-2 mx-auto hover:opacity-80 transition-opacity"
            >
