      ...
      <main className="flex-1 container mx-auto px-4 py-8 md:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 mb-20">
          ...
          <div className="space-y-4">
            <div className="relative aspect-square rounded-[2.5rem] overflow-hidden bg-secondary/30 border">
              <Image 
            ...
            <div className="grid grid-cols-4 gap-3">
              {images.map((img, i) => (
                <div 
                  ...
                  className={`relative aspect-square rounded-2xl overflow-hidden cursor-pointer border-2 transition-all ${activeImage === img ? 'border-primary' : 'border-transparent opacity-60'}`}
                >
          ...
          <div className="flex flex-col justify-center">
            <div className="mb-6 flex flex-wrap items-center gap-4">
              <Badge variant="secondary" className="bg-primary/10 text-primary px-3 py-1 font-bold uppercase text-[9px]">
            ...
            <h1 className="font-headline text-4xl md:text-6xl font-bold mb-4 tracking-tight leading-tight">{product.title}</h1>
            
            {/* Fix Hydration Error: Nested div in p */}
            ...
            <div className="text-4xl font-bold text-primary mb-8 tracking-tighter">
              ₦{product.price.toLocaleString()}
            </div>

            <p className="font-body text-xl text-muted-foreground leading-relaxed mb-10 italic">
              {product.description}
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Button size="lg" className="flex-1 rounded-full h-14 bg-primary font-bold shadow-xl shadow-primary/20 gap-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 pt-10 border-t">
              <div className="flex flex-col items-center sm:items-start gap-2">
                <ShieldCheck className="h-10 w-10 text-primary opacity-60" />
                <span className="text-[10px] font-bold uppercase tracking-widest">100% Authentic Quality</span>
              </div>
              <div className="flex flex-col items-center sm:items-start gap-2">
                <Truck className="h-10 w-10 text-primary opacity-60" />
                <span className="text-[10px] font-bold uppercase tracking-widest">Nationwide Delivery</span>
              </div>
              <div className="flex flex-col items-center sm:items-start gap-2">
        ...
        <div className="bg-white rounded-[3rem] p-8 md:p-14 border shadow-sm">
          <Tabs defaultValue="details">
            <TabsList className="bg-transparent border-b rounded-none w-full justify-start gap-10 h-auto p-0 mb-10 overflow-x-auto scrollbar-hide">
              <TabsTrigger value="details" className="data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none px-0 py-4 text-xl font-headline font-bold">Product Details</TabsTrigger>
              <TabsTrigger value="reviews" className="data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none px-0 py-4 text-xl font-headline font-bold">Verified Reviews ({product.numReviews || 0})</TabsTrigger>
              <TabsTrigger value="usage" className="data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none px-0 py-4 text-xl font-headline font-bold">How to Use</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="reviews">
              <div className="space-y-12">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 p-10 bg-primary/5 rounded-[2.5rem] border border-primary/10">
                  <div>
                    <h4 className="font-headline font-bold text-2xl mb-2">Review Summary</h4>
                  ...
                  {!reviewSummary ? (
                    ...
                    <div className="flex-1 max-w-2xl bg-white p-6 rounded-[2rem] shadow-sm border border-accent/20 italic">
                      <p className="text-base leading-relaxed">"{reviewSummary}"</p>
                    </div>
                  )}
                </div>
            ...
            <TabsContent value="usage" className="font-body text-xl text-muted-foreground leading-relaxed">
              <div className="space-y-6">
                 ...
                 <div className="p-8 bg-primary/5 rounded-[2rem] border-l-8 border-primary italic text-primary font-medium">
